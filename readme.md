...
- [ ] [wiki](https://github.com/chinanf-boy/brook-wiki-zh)
...
- Linux / MacOS / Windows 上的 VPN,也许你可以将它用于游戏[维基](https://github.com/txthinking/brook/wiki/How-to-run-VPN-on-Linux,-MacOS-and-Windows%3F)
...
Brook 是一个跨平台的 proxy/VPN 软件.<br/>brook 的目标是保持简单,傻瓜式和察觉不了.

## 下载

| 下载                                                                                                               | 服务器/客户端  | OS         | Arch架构     | 备注 |
| ------------------------------------------------------------------------------------------------------------------ | -------------- | ---------- | -------- | ---- |
...
**看[维基](https://github.com/txthinking/brook/wiki)了解更多教程**
...
看[维基](https://github.com/txthinking/brook/wiki)
...
看[维基](https://github.com/txthinking/brook/wiki/How-to-run-transparent-proxy-on-Linux%3F)
...
**看[维基](https://github.com/txthinking/brook/wiki/How-to-run-VPN-on-Linux,-MacOS-and-Windows%3F)了解更多教程**
